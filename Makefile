...
src=history.c shell.c ui.c shellper.c
obj=$(src:.c=.o)
...
shell.o: shell.c history.h logger.h ui.h shell.h shellper.h
history.o: history.c history.h logger.h
ui.o: ui.h ui.c logger.h history.h shell.h
shellper.o: shellper.c shellper.h logger.h
